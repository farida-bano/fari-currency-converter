...
console.log(chalk.bold.rgb(204, 204, 204)(`**********  ${chalk.bold.hex('#9999FF')('Welcome To \'Farida\'- Currency Converter')}  **********`));
console.log(chalk.bold.rgb(204, 204, 204)(`\t\t     **************************************>\n`));
// Define the list of currencies and their exchange rates
let exchange_rate = {
    "USD $": 1, //(Dollor) Base currency
    ...
    "SAU Ryl": 73.99, // Saudi (Riyal)
    "UAE Drm": 75.69, // United Arab Emirates(Drhum)
    "OM Ryal": 722.20 //Oman(Riyal)
};
...
let user_answer = await inquirer.prompt([
    {
        ...
        choices: ["USD $", "EUR £", "JPY ¥", "CAD $", "AUD $", "PKR Rs", "SAU Ryl", "UAE Drm"],
    },
    {
        name: "to_currency",
        type: "list",
